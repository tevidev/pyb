                    ...
                    if ((strpos(message, "/bin") === 0) || (strpos(message, "!bin") === 0) || (strpos(message, ".bin") === 0)) :
                            ...
                            if (empty(bank)) :
                                    ...
                                    exit()
                                        ...
                                        sendMessage(chatId, "<b>lookup%0A═════════════════%0A•├𝘽𝙄𝙉 : <code>bin</code>%0A•├𝙄𝙉𝙁𝙊 : <code>scheme</code>%0A•├𝙏𝙔𝙋𝙀: <code>type</code>%0A•├𝘽𝙍𝘼𝙉𝘿 : <code>brand</code>%0A•├𝘽𝘼𝙉𝙆 : <code>bank</code>%0A•├COUNTRY : <code>name</code> emoji%0A═════════════════%0A•├𝘾𝙃𝙀𝘾𝙆𝙀𝘿 𝘽𝙔 : @username <code>[rank]</code>%0Abotu</b>", message_id)
