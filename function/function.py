...
def send_reply(chatId, message_id, keyboard, message) :
        global website
...
def edit_sent_message(chatId, message_id, message) :
        global website
...
def editMessagei(chatId, message,message_id):
    global botToken
    ...
    def isUserSpamming(userId, cooldownInSeconds = 10) :
    ...
    # Example usage:
    userId = "6094779754" # Replace with the actual user ID
