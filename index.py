...
botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @spiderslatt"
bota = "<b>|×| 𝘿𝙀𝙑 ↯ @spiderslatt</b>"eror = "<b>Error ❌</b>"
...
keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https:#t.me/spiderslatt"],
        ],
    ]
])
...
channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝙊𝙒𝙉𝙀𝙍", 'url' => "https:#t.me/spiderslatt"], ['text' => "𝘾𝙃𝘼𝙉𝙉𝙀𝙇", 'url' => "https:#t.me/spiderslatt"]],
        [['text' => "𝙂𝙊 𝘽𝘼𝘾𝙆 ", 'callback_data' => 'back2']]
    ]
])
