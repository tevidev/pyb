                ...
                foreach (paidUsers as index => line) :
                    ...
                    if (preg_match('/^(\/sec|\.sec|!sec)/', text)) :
                        ...
                        if (_SERVER['REQUEST_METHOD'] == "POST") :
                            ...
                            headers[] = 'Accept-Language: en-US,enq=0.9'
                            ...
                            headers[] = 'accept: text/html,application/xhtml+xml,application/xmlq=0.9,image/webp,image/apng,*/*q=0.8,application/signed-exchangev=b3q=0.7'
                            headers[] = 'accept-language: en-US,enq=0.9'
                            headers[] = 'content-type: application/x-www-form-urlencoded'
