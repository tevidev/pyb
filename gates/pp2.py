                ...
                foreach (paidUsers as index => line) :
                    ...
                    if (preg_match('/^(\/lul|\.lul|!lul)/', text)) :
                        ...
                        #====ANTISPAM AND WRONG FORMAT====#
                            if (strlen(message) <= 4) :
                                        sendMessage(chatId, '<b>• Wrong Format! ⚠️</b>%0A• 𝘚𝘦𝘯𝘥 <code>/lul cc|mm|yy|cvv</code>%0A• 𝘎𝘢𝘵𝘦𝘸𝘢𝘺 <code>Paypal 2$ Charge ✅/code>', message_id)
                                        exit()
                        r = "0"
                        ...
                        if (_SERVER['REQUEST_METHOD'] == "POST") :
                            ...
                            serve_arr = ["gmail.com","homtail.com","yahoo.com.br","bol.com.br","yopmail.com","outlook.com"]
