                    ...
                    if (preg_match('/^(\/sd|\.sd|!sd)/', text)) :
                            ...
                            if (empty(cc) || empty(cvv) || empty(mes) || empty(ano)) :
                                ...
                                msg = trim(strip_tags(getStr(r6,'class="notice__content"><p class="notice__text">','</p></div></div>')))
                                      ...
                                      if (strpos(r6, 'Security code was not matched by the processor') || strpos(r6, 'Security codes does not match correct format (3-4 digits)') || (strpos(r6, "Address not Verified - Declined"))) :
                                          es = "𝘼𝙋𝙋𝙍𝙊𝙑𝙀𝘿 ✅"
                                          msg = "msg"
                                        } elseif (strpos(r6, 'Your order is confirmed') || strpos(r6, 'Thanks for supporting') || strpos(r6, '<div class="webform-confirmation">')) :
                                                es = "𝘼𝙋𝙋𝙍𝙊𝙑𝙀𝘿 ✅"
                                                msg = "msg"
                                              } elseif ((strpos(r6, 'No Match')) || (strpos(r6, 'Street address and postal code do not match.'))) :
                                                  es = "live"
